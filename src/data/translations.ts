...
export const T: Record<Lang, Record<string, string>> = {
  en: {
    ...
    hero_sub: "150+ businesses in Pakistan, UAE, UK, USA & KSA achieving real ROI with Meta Ads, Google Ads, SEO, Shopify, YouTube Automation & AI.",
    ...
    portfolio_sub: "150+ businesses achieving measurable growth",
